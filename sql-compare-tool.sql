...
SELECT @SOURCEDBSERVER = '[emssql4]' --==> Replace Your Source DB serverName Here

SELECT @DESTINATIONDBSERVER = '[emssql3]' --==> Replace Your Target DB serverName Here

SELECT @SOURCE_SQL_DBNAME = 'select name from ' + @SOURCEDBSERVER 
                            + '.master.sys.databases where database_id=10' 
...
AND STATUS<>'Available On Both Servers'
ORDER  BY dbname ASC 
